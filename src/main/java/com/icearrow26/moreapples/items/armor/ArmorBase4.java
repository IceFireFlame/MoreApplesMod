...
public class ArmorBase4 extends ItemArmor implements IHasModel {

	public ArmorBase4(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
